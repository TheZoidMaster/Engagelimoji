...
var twemoji = (function () {
    ...
    var twemoji = {
            ...
            replace: replace,
            test: test,
            parseNodeWithImageLinks: parseNodeWithImageLinks,
        },
        escaper = {
            "&": "&amp;",
            "<": "&lt;",
    ...
    function parseNode(node, options) {
        ...
        if (options.emojis) {
            node = parseNodeWithImageLinks(node, options);
        }
        return node;
    }

    function parseNodeWithImageLinks(node, options) {
        var allText = grabAllTextNodes(node, []),
            length = allText.length,
            modified,
            fragment,
